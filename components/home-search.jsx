...
// import processImageSeach from "@actions/home"
...
import { set } from 'date-fns';
 ...
 export default function HomeSearch(){
    ...
    const{
        ...
        data:searchResult,
        error:searchError,
    } = useFetch(processImageSeach);

    //handle search result with useEffect
    ...
    useEffect(()=>{
        if(processError){
            toast.error("Failed to analyze image:"+ (processError.message || "unkown error"));
        }
    },[processError])
    ...
    const onDrop = (acceptedFiles)=>{
        ...
        const {getRootProps,getInputProps,isDragActive,isDrapreject}=
        useDropzone({
            onDrop,
            accept: {
              "image/*": [".jpeg", ".jpg", ".png"],
        ...
        //handle image search submisisons
