...
export const CarFiltersControls = ({
    filters,
    currentFilters,
    onFilterChange,
    onClearFilter,
}) = {
    const {make,bodyType,fuleType,transmission,priceRange} = currentfilters;

    const filterSections=[
        {id:"make",
        title:"Make",
        options:filers.makes.map((make)=>({value:make,label:make})),
        currentValue:make,
